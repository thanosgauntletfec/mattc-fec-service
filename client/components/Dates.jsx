      ...
      return (
          ...
          <div className="calendar-wrapper">
            <div className={this.state.view === 'one' ? 'calendar' : "calendar cal-view-two"}>
              <div id="day1" content={day1} onClick={() => {this.props.props.selectDate(`${day1}`)}} className={this.props.props.date === `${day1}` ? "day day-selected" : "day"}>
                <div className="weekday">{day1[0]}</div>
                <div className="date">{day1[2]}</div>
                <div className="month">{day1[1]}</div>

              </div>
              <div id="day2" content={day2} onClick={() => {this.props.props.selectDate(`${day2}`)}} className={this.props.props.date === `${day2}` ? "day day-selected" : "day"}>
                <div className="weekday">{day2[0]}</div>
                <div className="date">{day2[2]}</div>
                <div className="month">{day2[1]}</div>
              </div>
              <div id="day3" content={day3} onClick={() => {this.props.props.selectDate(`${day3}`)}} className={this.props.props.date === `${day3}` ? "day day-selected" : "day"}>
                <div className="weekday">{day3[0]}</div>
                <div className="date">{day3[2]}</div>
                <div className="month">{day3[1]}</div>
              </div>
              <div id="day4" content={day4} onClick={() => {this.props.props.selectDate(`${day4}`)}} className={this.props.props.date === `${day4}` ? "day day-selected" : "day"}>
              ...
              <div id="day5" content={day5} onClick={() => {this.props.props.selectDate(`${day5}`)}} className={this.props.props.date === `${day5}` ? "day day-selected" : "day"}>
                <div className="weekday">{day5[0]}</div>
                <div className="date">{day5[2]}</div>
                <div className="month">{day5[1]}</div>
              </div>
              <div id="day6" content={day6} onClick={() => {this.props.props.selectDate(`${day6}`)}} className={this.props.props.date === `${day6}` ? "day day-selected" : "day"}>
                <div className="weekday">{day6[0]}</div>
                <div className="date">{day6[2]}</div>
                <div className="month">{day6[1]}</div>
              </div>
              <div id="day7" content={day7} onClick={() => {this.props.props.selectDate(`${day7}`)}} className={this.props.props.date === `${day7}` ? "day day-selected" : "day"}>
